package com.welspy.welspyserverv3.domain.s3.service;
...
import com.welspy.welspyserverv3.domain.s3.domain.entity.ImageEntity;
import com.welspy.welspyserverv3.domain.s3.domain.repository.S3JpaRepository;
...
public class S3Service {
    ...
    public String upload(MultipartFile image) {
        if(image.isEmpty() || Objects.isNull(image.getOriginalFilename())){
            throw new AmazonS3Exception("이미지가 비워져 있습니다.");
        }
