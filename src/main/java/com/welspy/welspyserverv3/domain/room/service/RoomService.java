package com.welspy.welspyserverv3.domain.room.service;

import com.welspy.welspyserverv3.domain.room.client.dto.MemberList;
import com.welspy.welspyserverv3.domain.room.client.dto.Room;
import com.welspy.welspyserverv3.domain.room.client.dto.request.RoomCreateRequest;
import com.welspy.welspyserverv3.domain.room.client.dto.request.RoomJoinRequest;
import com.welspy.welspyserverv3.domain.room.domain.entity.MemberListEntity;
import com.welspy.welspyserverv3.domain.room.domain.entity.RoomEntity;
import com.welspy.welspyserverv3.domain.room.domain.repository.jpa.MemberListJpaRepository;
import com.welspy.welspyserverv3.domain.room.domain.repository.jpa.RoomJpaRepository;
import com.welspy.welspyserverv3.domain.room.exception.MemberExistException;
import com.welspy.welspyserverv3.domain.room.exception.MemberLimitOverException;
import com.welspy.welspyserverv3.domain.room.exception.RoomNotFoundException;
import com.welspy.welspyserverv3.global.common.repository.UserSecurity;
